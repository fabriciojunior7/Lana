...
class Entidade(pygame.sprite.Sprite):
	def __init__(self, x, y, largura, altura, cor):	
		...
		self.direita = pygame.Rect((self.x - self.larguraDE + 2), self.y, self.larguraDE, self.alturaDE)
		self.esquerda = pygame.Rect((self.x + self.largura - 2), self.y, self.larguraDE, self.alturaDE)
